...
@property(nonatomic, assign) NSInteger  animationMaxDuration;
@end
...
- (void)followMarkerWithIdentifier:(nullable NSString *)markerId error:(FlutterError *_Nullable *_Nonnull)error;
@end
...
- (void)onMarkerUpdateToastMessage:(NSString *)message completion:(void (^)(FlutterError *_Nullable))completion;
@end
