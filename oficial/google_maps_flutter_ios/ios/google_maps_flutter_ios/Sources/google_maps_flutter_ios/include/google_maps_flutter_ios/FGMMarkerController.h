...
typedef void (^FGMMarkerMovedBlock)(NSString *markerId, CLLocationCoordinate2D newPosition, NSTimeInterval duration);
@property(copy, nonatomic, nullable) FGMMarkerMovedBlock onMarkerMoved;
typedef void (^FGMMarkerRemovedBlock)(NSString *markerId);
@property(copy, nonatomic, nullable) FGMMarkerRemovedBlock onMarkerRemoved;
