...
+ (instancetype)makeWithAlpha:(double )alpha
    ...
    maxDuration:(nullable NSNumber *)maxDuration {
  ...
  pigeonResult.maxDuration = maxDuration;
  return pigeonResult;
}
+ (FGMPlatformMarker *)fromList:(NSArray<id> *)list {
  FGMPlatformMarker *pigeonResult = [[FGMPlatformMarker alloc] init];
  ...
  pigeonResult.maxDuration = GetNullableObjectAtIndex(list, 15);
  return pigeonResult;
}
+ (nullable FGMPlatformMarker *)nullableFromList:(NSArray<id> *)list {
...
- (NSUInteger)hash {
  ...
  result = result * 31 + FLTPigeonDeepHash(self.speed);
  result = result * 31 + FLTPigeonDeepHash(self.maxDuration);
  return result;
}
@end
...
+ (instancetype)makeWithCompassEnabled:(nullable NSNumber *)compassEnabled
    ...
    animationMaxDuration:(NSInteger )animationMaxDuration {
  ...
  pigeonResult.animationSpeed = animationSpeed;
  pigeonResult.animationMaxDuration = animationMaxDuration;
  return pigeonResult;
}
+ (FGMPlatformMapConfiguration *)fromList:(NSArray<id> *)list {
  FGMPlatformMapConfiguration *pigeonResult = [[FGMPlatformMapConfiguration alloc] init];
  ...
  pigeonResult.animationSpeed = [GetNullableObjectAtIndex(list, 18) doubleValue];
  pigeonResult.animationMaxDuration = [GetNullableObjectAtIndex(list, 19) integerValue];
  return pigeonResult;
}
+ (nullable FGMPlatformMapConfiguration *)nullableFromList:(NSArray<id> *)list {
...
- (NSUInteger)hash {
  ...
  result = result * 31 + (isnan(self.animationSpeed) ? (NSUInteger)0x7FF8000000000000 : @(self.animationSpeed).hash);
  result = result * 31 + @(self.animationMaxDuration).hash;
  return result;
}
@end
...
void SetUpFGMMapsApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FGMMapsApi> *api, NSString *messageChannelSuffix) {
  ...
  /// If markerId is null, stops following.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.google_maps_flutter_ios.MapsApi.followMarker", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FGMGetGoogleMapsFlutterPigeonMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(followMarkerWithIdentifier:error:)], @"FGMMapsApi api (%@) doesn't respond to @selector(followMarkerWithIdentifier:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        NSString *arg_markerId = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api followMarkerWithIdentifier:arg_markerId error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
...
- (void)onMarkerUpdateToastMessage:(NSString *)arg_message completion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = [NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.google_maps_flutter_ios.MapsCallbackApi.onMarkerUpdateToast", _messageChannelSuffix];
  FlutterBasicMessageChannel *channel =
    [FlutterBasicMessageChannel
      messageChannelWithName:channelName
      binaryMessenger:self.binaryMessenger
