...
class PlatformMapConfiguration {
  PlatformMapConfiguration({
    ...
    required this.mapId,
    required this.style,
    this.animationSpeed = 60.0,
    this.animationMaxDuration = 5000,
  });
  ...
  final int animationMaxDuration;
}
...
abstract class MapsApi {
  ...
  /// Starts following a marker with the given ID.
  /// If markerId is null, stops following.
  @ObjCSelector('followMarkerWithIdentifier:')
  void followMarker(String? markerId);
}
...
abstract class MapsCallbackApi {
  ...
  /// Called to show a toast message about marker updates.
  void onMarkerUpdateToast(String message);
}
