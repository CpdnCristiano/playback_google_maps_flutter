...
class PlatformMapConfiguration {
  ...
  static PlatformMapConfiguration decode(Object result) {
    ...
    return PlatformMapConfiguration(
      ...
      animationSpeed: result[18]! as double,
      animationMaxDuration: result[19]! as int,
    );
  }
...
class MapsApi {
  ...
  Future<void> followMarker(String? markerId) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.google_maps_flutter_ios.MapsApi.followMarker$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
abstract class MapsCallbackApi {
  ...
  static void setUp(MapsCallbackApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.google_maps_flutter_ios.MapsCallbackApi.onMarkerUpdateToast$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
