...
class PlatformMarker {
  ...
  static PlatformMarker decode(Object result) {
    ...
    return PlatformMarker(
      ...
      speed: result[14] as double?,
      maxDuration: result[15] as int?,
    );
  }
...
class PlatformMapConfiguration {
  ...
  static PlatformMapConfiguration decode(Object result) {
    ...
    return PlatformMapConfiguration(
      ...
      animationSpeed: result[21]! as double,
      animationMaxDuration: result[22]! as int,
    );
  }
...
class MapsApi {
  ...
  Future<void> followMarker(String? markerId) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.google_maps_flutter_android.MapsApi.followMarker$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
abstract class MapsCallbackApi {
  ...
  static void setUp(MapsCallbackApi? api, {BinaryMessenger? binaryMessenger, String messageChannelSuffix = '',}) {
    ...
    {
      final pigeonVar_channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.google_maps_flutter_android.MapsCallbackApi.onMarkerUpdateToast$messageChannelSuffix', pigeonChannelCodec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        pigeonVar_channel.setMessageHandler(null);
      } else {
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          try {
            api.onMarkerUpdateToast(arg_message);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          }          catch (e) {
