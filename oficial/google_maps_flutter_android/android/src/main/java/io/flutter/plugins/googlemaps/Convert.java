...
class Convert {
  ...
  static void interpretMapConfiguration(
    ...
    sink.setAnimationDefaults(config.getAnimationSpeed(), (int)config.getAnimationMaxDuration());
  }
  ...
  static void interpretMarkerOptions(
    ...
    sink.setSpeed(marker.getSpeed());
    sink.setMaxDuration(marker.getMaxDuration());
  }
